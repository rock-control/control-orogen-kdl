...
void orogen_typekits::fromIntermediate(::KDL::Chain& real_type, ::wrappers::KDLChain const& intermediate)
{
    ...
    {
        ::KDL::Segment segment;
        orogen_typekits::fromIntermediate(segment, *it);
...
{
    orogen_typekits::fromIntermediate(real_type.p, intermediate.p);
    orogen_typekits::fromIntermediate(real_type.M, intermediate.M);
}
